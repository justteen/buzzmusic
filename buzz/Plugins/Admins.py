...
from buzz.Core.PyTgCalls.buzz import (pause_stream, resume_stream,
                                        skip_stream, skip_video_stream,
                                        stop_stream)
from buzz.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat,
                            remove_active_video_chat)
from buzz.Decorators.admins import AdminRightsCheck
from buzz.Decorators.checker import checker, checkerCB
from buzz.Inline import audio_markup, primary_markup, secondary_markup2
