...
from buzz.Database import (_get_authusers, delete_authuser, get_authuser,
                            get_authuser_count, get_authuser_names,
                            save_authuser)
from buzz.Decorators.admins import AdminActual
from buzz.Utilities.changers import (alpha_to_int, int_to_alpha,
                                      time_to_seconds)
...
/auth [Nama Pengguna atau Membalas Pesan]
 - Tambahkan pengguna ke DAFTAR AUTH grup.

/unauth [Nama Pengguna atau Membalas Pesan]
