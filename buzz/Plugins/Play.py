...
import buzz
from buzz import (BOT_USERNAME, DURATION_LIMIT, DURATION_LIMIT_MIN,
                   MUSIC_BOT_NAME, app, db_mem)
from buzz.Core.PyTgCalls.Converter import convert
from buzz.Core.PyTgCalls.Downloader import download
from buzz.Core.PyTgCalls.Tgdownloader import telegram_download
from buzz.Database import (get_active_video_chats, get_video_limit,
                            is_active_video_chat)
from buzz.Decorators.assistant import AssistantAdd
from buzz.Decorators.checker import checker
from buzz.Decorators.logger import logging
from buzz.Decorators.permission import PermissionCheck
from buzz.Inline import (livestream_markup, playlist_markup, search_markup,
                          search_markup2, url_markup, url_markup2)
from buzz.Utilities.changers import seconds_to_min, time_to_seconds
from buzz.Utilities.chat import specialfont_to_normal
from buzz.Utilities.stream import start_stream, start_stream_audio
from buzz.Utilities.theme import check_theme
from buzz.Utilities.thumbnails import gen_thumb
from buzz.Utilities.url import get_url
from buzz.Utilities.videostream import start_stream_video
from buzz.Utilities.youtube import (get_yt_info_id, get_yt_info_query,
...
async def play(_, message: Message):
    ...
    if message.sender_chat:
        return await message.reply_text(
            "Anda adalah Admin Anonim di Grup Obrolan ini!\nKembali ke Akun Pengguna Dari Hak Admin.""
        )
    audio = (
