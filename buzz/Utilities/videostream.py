...
from buzz import BOT_USERNAME, db_mem
from buzz.Core.PyTgCalls import Queues
from buzz.Core.PyTgCalls.buzz import (join_live_stream, join_video_stream,
                                        stop_stream)
from buzz.Database import (add_active_chat, add_active_video_chat,
                            is_active_chat, music_off, music_on,
                            remove_active_chat)
from buzz.Inline import (audio_markup, audio_markup2, primary_markup,
    ...
    if await is_active_chat(message.chat.id):
        ...
        if not await join_video_stream(message.chat.id, file, 720):
            return await mystic.edit(
                "Error Gabung Obrolan Suara. Pastikan OS menyala."
            )
